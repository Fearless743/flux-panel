...
func main() {
	...
	wsReporter := socket.StartWebSocketReporterWithConfig(config.Addr, config.Secret, config.Http, config.Tls, config.Socks, config.Ssl, version, config.SupportBrutal)
