...
const CONFIG_ITEMS: ConfigItem[] = [
  {
    ...
    description:
      '格式"ip:port"，多个地址用逗号分隔（如 1.2.3.4:6365,5.6.7.8:6365），用于节点自动切换备份面板地址。支持 IPv4/IPv6/域名，端口为面板后端映射端口。不要套CDN，不支持https，通讯数据有加密',
    type: "input",
  },
  {
    key: "app_name",
  ...
  },
  {
    ...
    description:
      "开启后，节点与面板之间的 WebSocket 通讯将使用 WSS 加密连接，需要在面板后端配置 SSL 证书",
    type: "switch",
  },
];
