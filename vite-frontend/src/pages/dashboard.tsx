    ...
    if (isUnlimited) {
      return (
        <div className="w-full">
          <div
            className={`w-full bg-gradient-to-r from-primary/20 to-secondary/20 rounded-full ${height}`}
          >
            <div
              className={`${height} bg-gradient-to-r from-primary to-secondary rounded-full w-full opacity-70`}
            />
          </div>
        </div>
      );
          ...
          <CardBody className="p-3.5 lg:p-4">
            <div className="flex flex-col space-y-2">
              <div className="flex items-center justify-between">
                <p className="text-xs lg:text-sm text-default-500 truncate">
                  总流量
                </p>
              ...
              <p className="text-base lg:text-xl font-bold text-foreground tracking-tight truncate">
            ...
            <div className="flex flex-col space-y-2">
              <div className="flex items-center justify-between">
                ...
                <div className="p-1.5 lg:p-2 bg-success/15 rounded-xl flex-shrink-0">
                  <svg
                    className="w-4 h-4 lg:w-5 lg:h-5 text-success"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                  >
                    <path
            ...
            <div className="flex flex-col space-y-2">
              <div className="flex items-center justify-between">
                ...
                <div className="p-1.5 lg:p-2 bg-warning/15 rounded-xl flex-shrink-0">
                  <svg
                    className="w-4 h-4 lg:w-5 lg:h-5 text-warning"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                  >
                    <path
              ...
              <div className="space-y-3">
                {userTunnels.map((tunnel) => {
                  ...
                  return (
                    <div
                      key={tunnel.id}
                      className="border border-divider rounded-xl p-3 lg:p-4 bg-content1/60 hover:shadow-panel transition-shadow"
                    >
            ...
            <div className="space-y-4">
              {groupedForwards().map((group) => (
                <div
                  ...
                  className="border border-divider rounded-xl p-3 lg:p-4 bg-content1/60"
                >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-4">
                    {group.forwards.map((forward) => (
                      <div
                        key={forward.id}
                        className="bg-content1 border border-divider rounded-xl p-3 hover:shadow-panel transition-shadow"
                      >
                        <div className="space-y-3">
                          <div>
